            ...
            <div className="forms-container1">
                <div className="signin-signup">
                    ...
                    <form action="" className="sign-up-form" onSubmit={handleSignupSubmit}>
                        ...
                        {error1 && <div className="error" style={{ color: "red" }}>{error1}</div>}
                        <p className="social-text">
            ...
            <div className="panels-container1">
                <div className="panel left-panel">
                    <div className="content">
                        <h3>New Here?</h3>
                        <p>Welcome! Sign up to experience our platform's full features and start your journey with us. It's quick and easy!</p>
                ...
                <div className="panel right-panel">
                    <div className="content">
                        ...
                        <p>If you're already a part of our community, just sign in to access your account and continue where you left off!</p>
